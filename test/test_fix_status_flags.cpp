...
TEST_CASE("fix status flags shall return different values of carrier phase solution status")
{
    ...
    fix_st_flags.carrier_phase_range_solution =
        static_cast<std::uint8_t>(carrier_phase_range_solution_status::no_solution);
    REQUIRE(fix_st_flags.get_carrier_phase_solution_status() == carrier_phase_range_solution_status::no_solution);
    fix_st_flags.carrier_phase_range_solution =
        static_cast<std::uint8_t>(carrier_phase_range_solution_status::with_floating_ambiguities);
    REQUIRE(fix_st_flags.get_carrier_phase_solution_status() ==
            carrier_phase_range_solution_status::with_floating_ambiguities);
    fix_st_flags.carrier_phase_range_solution =
        static_cast<std::uint8_t>(carrier_phase_range_solution_status::with_fixed_ambiguities);
    REQUIRE(fix_st_flags.get_carrier_phase_solution_status() ==
            carrier_phase_range_solution_status::with_fixed_ambiguities);
}
